...
class TestCalculator(unittest.TestCase):
    ...
    def test_get_daylight_len(self):
    ...
    def test_calculate_solar_energy_alg1(self):
        ...
        mock_get.assert_called()
        self.assertEqual(cal.calculate_solar_energy_alg1("2020-12-25", "6001", "08:00", "60", "PERTH"), (['2.4129'], [1.0]))

    def test_calculate_solar_energy_alg2(self):
    ...
    def test_cost_calculation_alg1_asg1(self):
    ...
    def test_cost_calculation_alg1_asg2(self):
        ...
        mock_get.assert_called()
        self.assertEqual(cal.cost_calculation_alg1_asg2("25/12/2020", "6001", "08:00", "90", "3", "45", "60", "Perth"), "1.08")

    def test_cost_calculation_alg2_asg2(self):
        postcode_data = [
            {"id": "22d72902-b72f-4ca0-a522-4dbfb77a7b78", "postcode": "7250", "name": "BLACKSTONE HEIGHTS",
             "state": "TAS", "latitude": "-41.46", "longitude": "147.0820001",
             "distanceToNearestWeatherStationMetres": 5607.391317385195,
